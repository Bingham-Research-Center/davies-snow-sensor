...
| Ultrasonic Sensor (waterproof probe) | JSN-SR04T (mode-select R19 left open → Mode 1) | 0+ per station | ~$15 | Amazon | 25–450 cm range, waterproof transducer on a pigtail. HC-SR04-compatible pulse-echo in Mode 1; declared under `sensors.jsn_sr04t` (own 25–450 cm valid range). ECHO needs the same 1k/2k divider. |
