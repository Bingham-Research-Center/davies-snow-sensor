...
from src.sensor.ultrasonic import UltrasonicSensor, speed_of_sound_m_s
...
class TestReadDistance:
    ...
    def test_valid_reading_median(self):
        ...
        assert result == 152.0  # median 1.52m = 152.0cm
        assert sensor.get_last_error_reason() is None
    ...
    def test_out_of_range_high(self):
        ...
        assert sensor.get_last_error_reason() == "ultrasonic_out_of_range"
    ...
    def test_mostly_none_readings(self):
        ...
        assert result is None
        assert sensor.get_last_error_reason() == "ultrasonic_unavailable"
    ...
    def test_not_initialized(self):
        ...
        assert result is None
        assert sensor.get_last_error_reason() == "ultrasonic_not_initialized"
        assert sensor.get_last_read_duration_ms() == 0
    ...
    def test_read_error_exception(self):
        ...
        assert result is None
        assert sensor.get_last_error_reason() == "ultrasonic_read_error"
    ...
    def test_rounding_to_one_decimal(self):
        ...
        assert result == 123.4  # round(123.45, 1) = 123.4 (banker's rounding)
        assert sensor.get_last_error_reason() is None
